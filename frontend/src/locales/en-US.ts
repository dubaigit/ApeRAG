...
`,
  ...
  'quota.type.max_collection_count': 'Max Collections',
  'quota.type.max_document_count': 'Max Total Documents',
  'quota.type.max_document_count_per_collection': 'Max Documents per Collection',
  'quota.type.max_bot_count': 'Max Bots',
  'quota.max_collection_count': 'Max Collections',
  'quota.max_document_count': 'Max Total Documents',
  'quota.max_document_count_per_collection': 'Max Documents per Collection',
  'quota.max_bot_count': 'Max Bots',
  ...
  'quota.management_tips': 'Manage user quota limits and usage',
  'quota.my_quotas': 'My Quotas',
  'quota.quotas': 'Quotas',
  'quota.edit_quota': 'Edit Quota',
  'quota.select_type': 'Select quota type',
  ...
  'quota.system_defaults': 'System Default Quotas',
  'quota.system_default_quotas': 'System Default Quotas',
  'quota.edit_system_defaults': 'Edit System Default Quotas',
  'quota.enter_default_limit': 'Enter default quota limit',
