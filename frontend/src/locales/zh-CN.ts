...
`,
  ...
  'quota.edit': '编辑配额',
  'quota.recalculate': '重新计算',
  'quota.update.success': '配额更新成功',
  'quota.update.failed': '配额更新失败',
  'quota.recalculate.success': '配额重新计算成功',
  'quota.recalculate.failed': '配额重新计算失败',
  'quota.type.max_collection_count': '最大知识库数量',
  'quota.type.max_document_count': '最大文档总数',
  'quota.type.max_document_count_per_collection': '单个知识库最大文档数',
  'quota.type.max_bot_count': '最大机器人数量',
  'quota.max_collection_count': '最大知识库数量',
  'quota.max_document_count': '最大文档总数',
  'quota.max_document_count_per_collection': '单个知识库最大文档数',
  'quota.max_bot_count': '最大机器人数量',
  'quota.fetch_error': '获取配额信息失败',
  'quota.update_error': '更新配额失败',
  'quota.recalculate_error': '重新计算配额失败',
  'quota.management_tips': '管理用户配额限制和使用情况',
  ...
  'quota.system_update_error': '更新系统默认配额失败',
